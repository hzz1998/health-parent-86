...
public class QiniuUtil {
    //七牛给你分配账号密码
    static String accessKey = "3Zy-khB5LooHTnLnGONlS8Nl3yoSMLOzUasXKJAf";
    static String secretKey = "TbBP5xjKWh5ReslyzCz69pPLJDE95TgN9KybdoLK";
    //自己创建的存储空间名称
    static String bucket = "86health";
